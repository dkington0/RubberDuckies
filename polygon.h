...
public:
     ...
     */
    polygon(): points{myStd::vector<QPoint>()} { setId(1 + num_shapes++);  setShapeTypeFlag(Shape::PolygonType); }
     ...
     */
    polygon(myStd::vector<QPoint>& p) : points{ p } { setId(1 + num_shapes++);  setShapeTypeFlag(Shape::PolygonType); }
     ...
     * @param p : vector to hold all of the QPoints for the polygon
     */
    polygon(int i, myStd::vector<QPoint>& p) : points{ p } { setId(i);  setShapeTypeFlag(Shape::PolygonType); }
